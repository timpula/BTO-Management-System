...
public class HDBManagerView {
    ...
    private void displayCreateProject(HDBManager manager) {
        ...
        newProject.setProjectId("PRJ" + System.currentTimeMillis());
        ...
        newProject.setVisibility(false); // Default to not visible until review
    ...
    private void displayApproveWithdrawalRequests(HDBManager manager) {
        ...
        // Note: In a real implementation, you would have a method to get withdrawal requests
        // For now, we'll simulate it with applications that have status "Withdrawal Requested"
    ...
    private void displayReportDetails(Report report, String reportType) {
        ...
        // Display report data - in a real implementation, this would show the actual data
        System.out.println("\nReport Data:");
