...
public class HDBOfficerView {
    ...
    private void displayProcessApplications(HDBOfficer officer) {
        ...
        switch (actionChoice) {
            case 1:
                ...
                break;
            case 2:
                boolean failure = officerController.updateApplicationStatus(selectedApp.getApplicationId(), "Unsuccessful");
                if (failure) {
    ...
    private void displayUpdateProfile(HDBOfficer officer) {
        ...
        switch (choice) {
            case 1:
                ...
                boolean updated = userController.updateProfile(officer);
    ...
    private void displayManageFlatSelection(HDBOfficer officer) {
        ...
        for (int i = 0; i < successfulApplications.size(); i++) {
            ...
            System.out.println((i + 1) + ". Application ID: " + app.getApplicationId());
            System.out.println("   Applicant: " + applicant.getName() + " (NRIC: " + applicant.getNric() + ")");
            System.out.println("   Flat Type (if selected): " + (app.getFlatType() != null ? app.getFlatType() : "Not selected yet"));
            System.out.println();
        }
    ...
    private void displayManageFlatSelectionForApplicant(HDBOfficer officer, Application application, Applicant applicant) {
        ...
        if (confirm.equalsIgnoreCase("Y")) {
            ...
            boolean profileUpdated = officerController.updateApplicantProfile(applicant.getNric(), project.getProjectId(), selectedFlatType);
            ...
            boolean flatCountUpdated = officerController.updateFlatRemaining(project.getProjectId(), selectedFlatType, currentCount - 1);
